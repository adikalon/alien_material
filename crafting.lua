...
minetest.register_craft({
	type = "shaped",
	output = "alien_material:alien_apple",
	recipe = {
		{"alien_material:alien_ingot",  "alien_material:alien_ingot",  "alien_material:alien_ingot",},
		{"alien_material:alien_ingot",  "default:apple",  "alien_material:alien_ingot",},
		{"alien_material:alien_ingot",  "alien_material:alien_ingot",  "alien_material:alien_ingot",},
	}
})
...
if minetest.get_modpath("farming") then
	minetest.register_craft({
		...
		recipe = {
			...
			{"farming:bread",  "alien_material:alien_ingot",  "farming:bread",},
			{"farming:bread",  "farming:bread",  "farming:bread",},
		}
	})
end
